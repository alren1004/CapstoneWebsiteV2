...
(function (a, b) {
    ...
    function m(c, d, e, f) {
        ...
        var R = d.data("zoom");
        if (R == "random") {
            if (Math.floor(Math.random() * 2) == 0)R = "out"; else R = "in"
        }
        ...
        if (d.data("endalign") != b) {
            ...
            var y = A.split(",")[0];
            var z = A.split(",")[1];
            if (y == "left")S = S + M / 4; else if (y == "center")S = S - M / 2; else if (y == "right")S = S - M;
            if (z == "top")T = T + N / 4; else if (z == "center")T = T - N / 2; else if (z == "bottom")T = T - N
        }
        ...
        j.parent().find(".canvas-now-bw").css({opacity: 0});
        if (B) {
            I.drawImage(j[0], s, r, O, P);
            if (k.length > 0) {
                K.drawImage(k[0], s, r, O, P);
                setTimeout(function () {
                    j.parent().find(".canvas-now-bw").cssAnimate({opacity: "1.0"}, {duration: 1e3, queue: false})
                }, 1200)
            }
        }
        j.cssStop(true, true);
        k.cssStop(true, true);
        j.css({position: "absolute", left: s + "px", top: r + "px", width: O + "px", height: P + "px", opacity: 1});
        k.css({position: "absolute", left: s + "px", top: r + "px", width: O + "px", height: P + "px", opacity: 1});
        var V = s;
        var W = r;
        var X = O;
        step = 0;
            ...
            if (!e.parent().parent().find(".kenburn_thumb_container #thumbmask").hasClass("overme") && !e.find(".slide_mainmask").hasClass("overme") && !e.find(".slide_mainmask").hasClass("videoon")) {
                ...
                if (B) {
                    ...
                    if (jQuery.browser.msie) {
                        ...
                        j.cssAnimate({left: s + "px", top: r + "px", width: O + "px", height: P + "px"}, {
                            duration: 38,
                            easing: "linear",
                            queue: false
                        });
        ...
        if (e.find(".kenburn_thumb_container").length > 0) {
            ...
            e.find(".kenburn_thumb_container #thumbmask .thumbsslide #thumb" + c.index()).each(function (b) {
                ...
                if (c.attr("id") != "thumb" + d.index()) {
                    ...
                    c.stop();
                    c.find(".overlay").animate({opacity: .75}, {duration: 300, queue: false})
                }
            });
            Z.addClass("selected");
            Z.find(".overlay").animate({opacity: 0}, {duration: 300, queue: false});
            ...
            if (Z.position().left + f.thumbWidth == f.thumbmaxwidth && Z.index() != f.maxitem - 1) {
                Z.parent().find(".kenburn-thumbs").each(function () {
                    var b = a(this);
                    b.cssAnimate({left: b.position().left - f.thumbWidth + "px"}, {duration: 300, queue: false})
                })
            }
            ...
            if (Z.index() == 0) {
                Z.parent().find(".kenburn-thumbs").each(function () {
                    var b = a(this);
                    b.cssAnimate({left: 0 + b.index() * f.thumbWidth + "px"}, {duration: 300, queue: false})
                })
            }
        }
    ...
    function k(b, c) {
        ...
        d.mouseenter(function (d) {
            ...
            b.find(".kenburn_thumb_container").animate({opacity: 1}, {duration: 300, queue: false})
        });
        d.mouseleave(function (d) {
            ...
            setTimeout(function () {
                if (c.hideThumbs == "on" && !i.hasClass("overme") && !a("body").hasClass("tp_showthumbsalways")) {
                    b.find(".kenburn_thumb_container").animate({opacity: 0}, {duration: 300, queue: false})
                }
            }, 10)
        });
        d.mousemove(function (d) {
            ...
            var f = e.parent().find(".kenburn_thumb_container #thumbmask");
            b.find(".kenburn_thumb_container").css({display: "block"});
    ...
    function j(c, d) {
        if (a.browser.msie) {
            c.find(".kenburn-preloader").animate({opacity: "0.0"}, {duration: 300, queue: false})
        } else {
            c.find(".kenburn-preloader").cssAnimate({opacity: "0.0"}, {duration: 300, queue: false})
        }
        setTimeout(function () {
    ...
    function h(b, c) {
        ...
        b.find("ul >li").each(function (e) {
            ...
            j.append(k);
            if (e == d)j.css({"margin-right": "0px"});
            o.append(j);
            if (e == c.lastThumb) {
                j.addClass("selected");
                j.find(".overlay").css({opacity: 0})
            } else {
                j.find(".overlay").css({opacity: .75});
            ...
            n.hover(function () {
                var b = a(this);
                b.stop();
                b.find(".overlay").animate({opacity: 0}, {duration: 300, queue: false})
            }, function () {
                var b = a(this);
                b.stop();
                if (!b.hasClass("selected"))b.find(".overlay").animate({opacity: .75}, {duration: 300, queue: false})
            });
            n.click(function () {
                var e = a(this);
                if (e.position().left + c.thumbWidth == c.thumbmaxwidth && e.index() != d - 1) {
                    e.parent().find(".kenburn-thumbs").each(function () {
                        var b = a(this);
                        b.cssAnimate({left: b.position().left - c.thumbWidth + "px"}, {duration: 300, queue: false})
                    })
                }
        ...
        if (c.thumbVertical == "bottom") {
            l.css({"z-index": 1e3, top: c.thumbYOffset + (c.height - c.thumbHeight) + "px"})
        } else {
            if (c.thumbVertical == "center") {
                l.css({"z-index": 1e3, top: c.thumbYOffset + (c.height / 2 - c.thumbHeight / 2) + "px"})
            } else {
                l.css({"z-index": 1e3, top: c.thumbYOffset + "px"})
            }
        }
        if (c.thumbHorizontal == "left") {
            l.css({left: c.thumbXOffset + "px"})
        } else {
            if (c.thumbHorizontal == "right") {
                l.css({left: c.thumbXOffset + (c.width - e) + "px"})
            } else {
                l.css({left: c.thumbXOffset + l.position().left + "px"})
            }
        }
    }
    ...
    function f(c, d, e) {
        c.find("ul >li").each(function (f) {
            if (f == e) {
                ...
                if (a(window).width() <= 480)c.addClass("kb-minisize"); else if (a(window).width() <= 767)c.addClass("kb-smallsize"); else if (a(window).width() <= 959)c.addClass("kb-mediumsize"); else if (a(window).width() > 959)c.addClass("kb-fullsize");
                ...
                g.find(".slide_container .parallax_container .kb_container .video_kenburner").each(function () {
                    ...
                    e.click(function () {
                        ...
                        if (d.videoWasOn == 1)f.animate({top: "0px"}, {
                            duration: 0,
                            queue: false
                        }); else f.animate({top: "0px"}, {duration: 500, queue: false});
        ...
        c.waitForImages(function () {
            ...
            f.waitForWF = setInterval(function () {
                ...
                if (a("body").data("googlefonts") != b && a("body").data("googlefonts") == "loaded") {
                    ...
                    e(c, f);
                    if (f.thumbStyle == "both")c.find(".thumbbuttons").css({visibility: "hidden"});
    ...
    a.fn.extend({
        kenburn: function (d) {
            ...
            WebFontConfig = {
                google: {families: [d.googleFonts]}, active: function () {
