/* dCodes Framework: (c) Mike Ilsley, TemplateAccess */
...
$(function(){
	...
	$('#slider-one').movingBoxes({
		...
		panelWidth   : .3,     // current panel width adjusted to 70% of overall width (.2 = more products on screen | .8 = less products)
		buildNav     : true,
