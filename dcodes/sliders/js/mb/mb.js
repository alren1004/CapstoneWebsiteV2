/* dCodes Framework: (c) Chris Coyier, TemplateAccess */
...
(function ($) {
    $.movingBoxes = function (el, options) {
        ...
        base.change = function (curPanel, callback, flag) {
            ...
            if (!base.currentlyMoving) {
                ...
                ani = (base.options.fixedHeight) ? {scrollLeft: leftValue} : {
    ...
    $.movingBoxes.defaultOptions = {
        ...
        // Selectors & classes
        currentPanel: 'mb_current', // current panel class
        tooltipClass: 'mb_tooltip', // added to the navigation, but the title attribute is blank unless the link text-indent is negative
