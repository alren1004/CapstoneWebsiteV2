    ...
    $.jfancytile = function (el, options) {
        ...
        base.init = function () {
            ...
            for (var img in imageData) {
                ...
                // Calculate tile size
                var tileDimension = {
                    width: Math.floor((imageData[img].width / base.options.columnCount)),
                    height: Math.floor((imageData[img].height / base.options.rowCount))
                };
        ...
        var navigate = function (direction) {
            ...
            base.$el.children().not("div.jfancytilenav").children().eq(currentImageIndex).children().not(".jfancytileTitle").each(function () {
                ...
                switch (direction) {
                    case 0:
                        $(this).animate({
                            top: '+=' + tileDimension.height,
                            opacity: 0
                        }, base.options.outSpeed, base.options.outEasing, function () {
                            $(this).css({display: "none"})
                        });
                        break;
                    case 1:
                        $(this).animate({
                            left: '+=' + tileDimension.width,
                            opacity: 0
                        }, base.options.outSpeed, base.options.outEasing, function () {
                            $(this).css({display: "none"})
                        });
            ...
            base.$el.children().not("div.jfancytilenav").children().eq(currentImageIndex).children().not(".jfancytileTitle").each(function () {
                ...
                $(this).css({display: "block"}).animate({
                    ...
                    left: 0,
                    opacity: 1
                }, base.options.inSpeed, base.options.inEasing);
            });
