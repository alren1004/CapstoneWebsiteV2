var Froogaloop = function () {
    ...
    function i(a) {
        ...
        a = b.value;
        var c = b.data, f = f == "" ? null : b.player_id;
    ...
    g.fn = g.prototype = {
        playerDomain: "", element: null, init: function (a) {
            ...
            var c = this.element, f = c.id != "" ? c.id : null, e = !b || !b.constructor || !b.call || !b.apply ? b : null, d = b && b.constructor && b.call && b.apply ? b : null;
            d && j(a, d, f);
            h(a, e, c);
            return this
