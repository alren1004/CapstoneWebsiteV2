    ...
    function setBulPos(container, opt) {
        ...
        if (opt.navigationType == "bullet") {
            ...
            if (opt.navigationArrows == "nexttobullets") {
                ...
                la.css({
                    'position': 'absolute', 'left': (bullets.position().left - la.outerWidth(true)) + "px",
                    'top': bullets.position().top + "px"
                });

                ra.css({
                    'position': 'absolute', 'left': (bullets.outerWidth(true) + bullets.position().left) + "px",
                    'top': bullets.position().top + "px"
                });
            } else {
    ...
    function swapSlide(container, opt) {
            ...
            nextsh.find('.slotslide').each(function (j) {
                ...
                if (opt.firefox13) {
                    ss.find('img').animate({
                        ...
                        'top': (0 - ss.data('y')) + "px",
                        'left': (0 - ss.data('x')) + 'px'
                    }, {duration: rand, queue: false});
                    ss.animate({'opacity': 1}, {
                        duration: rand, queue: false, complete: function () {
                            if (j == (opt.slots * opt.slots) - 1) {
                                removeSlots(container);
                                nextsh.find('.defaultimg').css({'opacity': 1});
                                actsh.find('.defaultimg').css({'opacity': 0});
        ...
        if (nexttrans == 4) {
            ...
            actsh.find('.slotslide').each(function (i) {
                ...
                ss.cssAnimate({'top': (0 + (opt.height)) + "px", 'opacity': 1}, {
                    duration: masterspeed + (i * (70 - opt.slots)), queue: false, complete: function () {
        ...
        if (nexttrans == 6) {
            ...
            nextsh.find('.slotslide').each(function (i) {
                ...
                if (opt.firefox13) {
                    ss.animate({'top': '0px', 'opacity': 1}, {
                        duration: masterspeed + tempo, queue: false, complete: function () {
        ...
        actli.find('.caption').each(function (i) {
            ...
            try {
                nextcaption.animate({
                    ...
                    'left': ll + 'px',
                    'top': tt + "px"
                }, {duration: nextcaption.data('speed'), easing: easetype});
            } catch (e) {
            }
        });
    }
