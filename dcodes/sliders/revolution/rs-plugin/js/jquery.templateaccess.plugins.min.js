...
(function (a, b) {
    ...
    a.css3D = function (b) {
        a("body").data("cssPerspective", isFinite(b) ? b : b ? 1e3 : 0).cssOriginal(a.cssMerge({}, {TransformStyle: b ? "preserve-3d" : "flat"}, c))
    };
    ...
    a.fn.cssStop = function () {
        ...
        b.data("cssAnimations", false).each(function (f, g) {
            ...
            setTimeout(function () {
                var c = a(b[d]);
                c.cssOriginal(i).data({runningCSS: {}, cssAnimations: {}, cssQueue: [], cssRunning: false});
