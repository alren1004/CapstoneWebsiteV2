...
(function (window, document, undefined) {
    ...
    function ea(a) {
        ...
        if (d == "")d = "Unknown";
        var e = "Unknown";
        if (a.c.indexOf("Chrome") != -1 || a.c.indexOf("CrMo") != -1)e = "Chrome"; else if (a.c.indexOf("Safari") != -1)e = "Safari"; else if (a.c.indexOf("AdobeAIR") != -1)e = "AdobeAIR";
        var f = "Unknown";
        if (a.c.indexOf("Version/") != -1)f = C(a, a.c, /Version\/([\d\.\w]+)/, 1); else if (e == "Chrome")f = C(a, a.c, /(Chrome|CrMo)\/([\d\.]+)/, 2); else if (e == "AdobeAIR")f = C(a, a.c, /AdobeAIR\/([\d\.]+)/, 1);
        var g = false;
        if (e == "AdobeAIR") {
            g =
                C(a, f, /\d+\.(\d+)/, 1);
