...
(function ($) {
    $.fn.tinyscrollbar = function (options) {
        var defaults = {axis: 'y', wheel: 40, scroll: true};
        var options = $.extend(defaults, options);
        var oWrapper = $(this);
        var oViewport = {obj: $('.dc_cs_viewport', this)};
        var oContent = {obj: $('.dc_cs_overview', this)};
        var oScrollbar = {obj: $('.dc_cs_scrollbar', this)};
        var oTrack = {obj: $('.dc_cs_track', oScrollbar.obj)};
        var oThumb = {obj: $('.dc_cs_thumb', oScrollbar.obj)};
